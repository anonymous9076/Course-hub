        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <Link to="https://Diginotes.com/" className="flex items-center">
                <img
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul className="!text-secondary font-medium">
                  <li className="mb-4">
                    <Link to="https://Diginotes.com/" className="text-secondary hover:underline">
                      Diginotes
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="text-secondary font-medium">
                  <li className="mb-4">
                    <Link
                      to="https://github.com/themesberg/Diginotes"
                      className="text-secondary hover:underline "
                    >
                      Github
                    </Link>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <Link
                to="#"
                className="text-primary hover:text-gray-900 ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
